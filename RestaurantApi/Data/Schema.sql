...
-- Drop child tables first (most dependent)
...
-- Drop parent tables (least dependent)
...
-- Categories table (master data, no shift)
...
-- MenuItemGrossProfitHistory table (tracks pricing and profitability metrics over time)
IF OBJECT_ID('MenuItemGrossProfitHistory', 'U') IS NULL
BEGIN
